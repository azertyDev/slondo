...
module.exports = __webpack_require__("cmv1");
...
// CONCATENATED MODULE: ./src/components/cabinet/cabinet_pages/my_ancmnts/useStyles.js

const useStyles = Object(styles_["makeStyles"])(theme => ({
  root: {}
}));
// CONCATENATED MODULE: ./src/components/cabinet/cabinet_pages/my_ancmnts/MyAncmnts.tsx
var __jsx = external_react_default.a.createElement;
...
const MyAncmnts = () => {
  ...
  return __jsx("div", {
    className: classes.root
  }, __jsx(ListView["a" /* ListView */], {
    isFetch: false,
    list: [] // safeShopping={props.safeShopping}
...
// CONCATENATED MODULE: ./src/components/cabinet/cabinet_pages/my_ancmnts/MyAncmntsContainer.tsx
var MyAncmntsContainer_jsx = external_react_default.a.createElement;



const MyAncmntsContainer = props => {
  const tabsData = [{
    title: 'Объявления',
    count: 2,
    component: MyAncmntsContainer_jsx(MyAncmnts, null)
  }, {
  ...
  return MyAncmntsContainer_jsx(TabsContent["a" /* TabsContent */], {
    title: title,
    tabsData: tabsData,
    headerTitle: title,
    t: props.t
...
// CONCATENATED MODULE: ./pages/cabinet/myAncmnts.tsx
var myAncmnts_jsx = external_react_default.a.createElement;




const myAncmnts_MyAncmnts = props => {
  return myAncmnts_jsx(MyAncmntsContainer, props);
};

myAncmnts_MyAncmnts.getInitialProps = async () => ({
  namespacesRequired: ['cabinet']
});

/* harmony default export */ var myAncmnts = __webpack_exports__["default"] = (Object(i18n["f" /* withTranslation */])(['cabinet'])(myAncmnts_MyAncmnts));
