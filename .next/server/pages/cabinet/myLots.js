...
module.exports = __webpack_require__("jusX");
...
// CONCATENATED MODULE: ./src/components/cabinet/cabinet_pages/my_lots/useStyles.js

const useStyles = Object(styles_["makeStyles"])(theme => ({
  root: {}
}));
// CONCATENATED MODULE: ./src/components/cabinet/cabinet_pages/my_lots/MyLotsComponent.tsx
var __jsx = external_react_default.a.createElement;
 // styles


const MyLotsComponent = props => {
  const classes = useStyles();
  return __jsx("div", {
    className: classes.root
  }, __jsx("div", null, "My lots"));
};
// CONCATENATED MODULE: ./src/components/cabinet/cabinet_pages/my_lots/MyLotsContainer.tsx
var MyLotsContainer_jsx = external_react_default.a.createElement;



const MyLotsContainer = props => {
  const tabsData = [{
    title: 'Созданные',
    count: 5,
    component: MyLotsContainer_jsx(MyLotsComponent, null)
  }, {
    title: 'Участие',
    count: 7,
    component: MyLotsContainer_jsx(MyLotsComponent, null)
  ...
  return MyLotsContainer_jsx(TabsContent["a" /* TabsContent */], {
    title: title,
    tabsData: tabsData,
    headerTitle: title,
    t: props.t
...
// CONCATENATED MODULE: ./pages/cabinet/myLots.tsx
var myLots_jsx = external_react_default.a.createElement;




const MyLots = props => {
  return myLots_jsx(MyLotsContainer, props);
};
...
/* harmony default export */ var myLots = __webpack_exports__["default"] = (Object(i18n["f" /* withTranslation */])(['cabinet'])(MyLots));
