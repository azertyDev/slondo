...
module.exports = __webpack_require__("8JqM");
...
// EXTERNAL MODULE: ./src/api/api.tsx
var api = __webpack_require__("Qff4");
...
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/useStyles.js
...
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/CreateAncmnt.tsx
var __jsx = external_react_default.a.createElement;



const CreateAncmnt = props => {
  const {
    ancmntType,
    searchTxt,
    subLvlCtgrs,
  ...
  return __jsx(core_["Grid"], {
    ...
    className: "header"
  }, __jsx(core_["Typography"], null, "\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044E")), __jsx(core_["List"], null, categoriesList.map(ctgr => (ancmntType.id === 1 || ctgr.has_auction === 1) && __jsx(core_["ListItem"], {
    key: ctgr.id,
    ...
    src: ctgr.icon.url,
    alt: ctgr.name
  }), ctgr.name))))), __jsx(core_["Grid"], {
    item: true,
    xs: 9,
    className: "sub-categories-menu"
  }, __jsx("div", {
    className: "search-block"
  }, __jsx(core_["InputBase"], {
  ...
  }, __jsx(core_["Typography"], null, "...Loading")) : error ? __jsx(core_["Typography"], {
    className: "error-text"
  }, error) : __jsx(core_["List"], null, subLvlCtgrs.map((ctgr, i) => __jsx(core_["ListItem"], {
    key: i,
    onClick: handleCategory(ctgr)
  }, __jsx("div", null, __jsx(core_["Typography"], {
    variant: "subtitle1"
  }, ctgr.name), !!searchTxt && __jsx(core_["Typography"], {
    className: "parent-category",
    variant: "subtitle2"
  }, parent.name))))))))), __jsx(core_["Hidden"], {
    smDown: true
  }, __jsx(core_["Grid"], {
    item: true,
    md: 3,
...
// CONCATENATED MODULE: ./src/components/elements/custom_checkbox/CustomCheckbox.tsx
var CustomCheckbox_jsx = external_react_default.a.createElement;
...
const CustomCheckbox = props => {
  return CustomCheckbox_jsx(core_["Checkbox"], _extends({
    color: "primary"
  }, props));
};
...
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/preview_photos/CustomDroppable.tsx
var CustomDroppable_jsx = external_react_default.a.createElement;

function CustomDroppable_extends() { CustomDroppable_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return CustomDroppable_extends.apply(this, arguments); }
...
const CustomDroppable = props => {
  ...
  return CustomDroppable_jsx(external_react_beautiful_dnd_["Droppable"], {
    isCombineEnabled: true,
    droppableId: droppableId,
    direction: "horizontal"
  }, provided => CustomDroppable_jsx(core_["Grid"], CustomDroppable_extends({
    container: true,
    ...
    if (droppableId === 'firstRow' && index <= 3 || droppableId === 'secondRow' && index > 3) {
      return isUrl ? CustomDroppable_jsx(external_react_beautiful_dnd_["Draggable"], {
        key: index,
        index: index,
        ...
        md: 3,
        ref: provided.innerRef
      }, provided.draggableProps, provided.dragHandleProps), CustomDroppable_jsx("img", {
        src: url,
        style: {
          width: '160px',
          height: '120px',
        ...
        alt: file.name
      }), CustomDroppable_jsx(Button["a" /* ButtonComponent */], {
        disabled: isPreview,
        onClick: removeFile(url)
      }, "X"))) : !isPreview && CustomDroppable_jsx(external_react_["Fragment"], {
        key: index
      }, url);
    }
  }), provided.placeholder));
};
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/preview_photos/PreviewPhotos.tsx
var PreviewPhotos_jsx = external_react_default.a.createElement;
...
const PreviewPhotos = props => {
  ...
  const handleUploadFile = ({
    ...
    if (totalFilesSize + selectedFilesSize <= constants["d" /* TOTAL_FILES_SIZE_LIMIT */]) {
  ...
  const removeFile = url => () => {
    files.map((item, index) => {
      if (item.url === url) {
        ...
        setValues(_objectSpread(_objectSpread({}, values), {}, {
          files: [...files, initPhoto]
        }));
      }
    });
  };

  return PreviewPhotos_jsx("div", null, PreviewPhotos_jsx("input", {
    type: "file",
    disabled: isPreview,
    onChange: handleUploadFile,
    multiple: true,
    accept: "image/png,image/jpeg"
  }), PreviewPhotos_jsx(external_react_beautiful_dnd_["DragDropContext"], {
    enableDefaultSensors: true,
    onDragEnd: handleOnDragEnd
  }, PreviewPhotos_jsx(CustomDroppable, {
...
// CONCATENATED MODULE: ./src/components/elements/custom_menu/CustomMenu.tsx
var CustomMenu_jsx = external_react_default.a.createElement;
...
const CustomMenu = props => {
  ...
  return CustomMenu_jsx("div", {
    style: {
      width: '100%'
    },
    className: props.className
  }, CustomMenu_jsx(Button["a" /* ButtonComponent */], {
    style: {
    ...
    name: props.name,
    onBlur: onBlur
  }, CustomMenu_jsx(core_["Typography"], {
    style: {
      color: '#4e4e4e'
    }
  }, valueName)), CustomMenu_jsx(core_["Menu"], {
    anchorEl: anchor,
    open: Boolean(anchor),
    onClose: handleMenuClose
  }, items.map((item, i) => CustomMenu_jsx(core_["MenuItem"], {
    key: i,
    id: item.name,
    onClick: onClick(item, setAnchor)
  }, CustomMenu_jsx(core_["Typography"], null, item[getValByName])))));
};
// EXTERNAL MODULE: external "@material-ui/lab"
var lab_ = __webpack_require__("RnCP");

// CONCATENATED MODULE: ./src/components/elements/location_autocomplete/LocationAutocomplete.tsx
var LocationAutocomplete_jsx = external_react_default.a.createElement;

function LocationAutocomplete_extends() { LocationAutocomplete_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return LocationAutocomplete_extends.apply(this, arguments); }

function LocationAutocomplete_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function LocationAutocomplete_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { LocationAutocomplete_ownKeys(Object(source), true).forEach(function (key) { LocationAutocomplete_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { LocationAutocomplete_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function LocationAutocomplete_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
const LocationAutocomplete = (_ref) => {
  ...
  const onChange = (_, val) => {
    setValues(LocationAutocomplete_objectSpread(LocationAutocomplete_objectSpread({}, values), {}, {
      location: val
    }));
  };

  return LocationAutocomplete_jsx(lab_["Autocomplete"], {
    ...
    renderInput: params => {
      return LocationAutocomplete_jsx(core_["TextField"], LocationAutocomplete_extends({
        fullWidth: true,
        focused: false,
        variant: "outlined"
      }, params, props));
...
// CONCATENATED MODULE: ./src/components/elements/custom_formik_textarea/CustomFormikTextarea.tsx
var CustomFormikTextarea_jsx = external_react_default.a.createElement;

function CustomFormikTextarea_extends() { CustomFormikTextarea_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return CustomFormikTextarea_extends.apply(this, arguments); }




const CustomFormikTextarea = props => {
  return CustomFormikTextarea_jsx(external_formik_["Field"], props, ({
    field
  }) => CustomFormikTextarea_jsx(core_["TextareaAutosize"], CustomFormikTextarea_extends({}, field, props)));
};
// EXTERNAL MODULE: external "yup"
var external_yup_ = __webpack_require__("C8TP");

// CONCATENATED MODULE: ./validation_schemas/createAdvrtSchema.ts
...
const lazyAdParams = Object(external_yup_["lazy"])(value => Object(external_yup_["object"])(Object.entries(value).reduce((acc, [key]) => {
  if (isRequired(key)) {
    if (typeof value[key] === 'object') {
      acc[key] = Object(external_yup_["object"])({
        id: Object(external_yup_["number"])().nullable().required(requiredMsg)
      });
    } else {
      acc[key] = Object(external_yup_["string"])().required(requiredMsg);
    }
  }

  return acc;
}, {})));
const createAdvrtSchema = Object(external_yup_["object"])().shape({
  title: Object(external_yup_["string"])().required(requiredMsg),
  price: Object(external_yup_["string"])().required(requiredMsg),
  currency: Object(external_yup_["lazy"])(value => value !== undefined ? Object(external_yup_["object"])({
    id: Object(external_yup_["number"])().nullable().required(requiredMsg)
  }) : Object(external_yup_["mixed"])().notRequired()),
  location: Object(external_yup_["object"])({
    city_id: Object(external_yup_["number"])().required(requiredMsg)
  }).nullable().required(requiredMsg),
  files: Object(external_yup_["array"])().required(requiredMsg),
  description: Object(external_yup_["string"])().required(requiredMsg),
  adParams: lazyAdParams
});
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/ancmnt_params/useStyles.js
...
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/ancmnt_params/AncmntParameter.tsx
var AncmntParameter_jsx = external_react_default.a.createElement;
...
const AncmntParameter = props => {
  ...
  if (isSpecialRows && isNotEmptyArray) {
    fields = AncmntParameter_jsx(external_react_default.a.Fragment, null, AncmntParameter_jsx(core_["Typography"], {
      variant: "subtitle1"
    }, AncmntParameter_jsx("strong", null, t(keyName)), isRequired(keyName) && AncmntParameter_jsx("span", {
      className: "error-text"
    }, "*"), adParamsError && adParamsTouched && adParamsError[keyName] && adParamsTouched[keyName] && adParamsTouched[keyName].id && AncmntParameter_jsx("span", {
      className: "error-text"
    }, " ", adParamsError[keyName].id)), AncmntParameter_jsx("div", {
      className: "row-list"
    }, data.map(item => AncmntParameter_jsx("div", {
      key: item.id
    }, keyName === 'body' ? AncmntParameter_jsx("div", {
    ...
    }, AncmntParameter_jsx(core_["Typography"], null, item.name)) : keyName === 'colors' ? AncmntParameter_jsx("div", {
      onClick: !isPreview ? handleListItem(keyName, item) : null,
      className: adParams[keyName] && adParams[keyName].id === item.id ? classes.selected : '',
      style: {
        width: '50px',
    ...
    }) : AncmntParameter_jsx("div", {
      style: {
        display: 'flex',
        alignItems: 'center'
      }
    }, AncmntParameter_jsx(CustomCheckbox, {
      disabled: isPreview,
      checked: adParams[keyName] && adParams[keyName].some(val => val.id === item.id),
      onChange: handleParamsCheckbox(keyName, item)
    }), AncmntParameter_jsx(core_["Typography"], null, item.name))))));
    ...
    fields = AncmntParameter_jsx(external_react_default.a.Fragment, null, AncmntParameter_jsx(core_["Typography"], {
      variant: "subtitle1"
    }, AncmntParameter_jsx("strong", null, t(newKey), isRequired(newKey) && AncmntParameter_jsx("span", {
      className: "error-text"
    }, "*")), adParamsError && adParamsTouched && adParamsError[newKey] && adParamsTouched[newKey] && AncmntParameter_jsx("span", {
      className: "error-text"
    }, " ", adParamsError[newKey].id)), AncmntParameter_jsx(core_["Grid"], {
      container: true
    }, isTextFieldKey && AncmntParameter_jsx(core_["Grid"], {
      item: true,
      xs: 9
    }, AncmntParameter_jsx(core_["TextField"], {
      fullWidth: true,
      variant: "outlined",
    ...
    })), AncmntParameter_jsx(core_["Grid"], {
      item: true,
      xs: isTextFieldKey ? 3 : 12
    }, AncmntParameter_jsx(CustomMenu, {
      name: keyName,
      onBlur: onBlur,
    ...
    fields = AncmntParameter_jsx(external_react_default.a.Fragment, null, AncmntParameter_jsx(core_["Typography"], {
      variant: "subtitle1"
    }, t(keyName), isRequired(keyName) && !isPreview && AncmntParameter_jsx("span", {
      className: "error-text"
    }, "*"), adParamsError && adParamsTouched && adParamsError[keyName] && adParamsTouched[keyName] && AncmntParameter_jsx("span", {
      className: "error-text"
    }, " ", adParamsError[keyName])), isPreview ? AncmntParameter_jsx(core_["Typography"], null, typeof adParams[keyName] === 'string' ? adParams[keyName] : adParams[keyName].name) : AncmntParameter_jsx(core_["TextField"], {
      fullWidth: true,
      name: keyName,
      variant: "outlined",
  ...
  fields = fields ? AncmntParameter_jsx(core_["Grid"], {
    item: true,
    container: true,
    xs: 12,
    className: classes.gridItem,
    sm: isSpecialRows && !isPreview || isOptions ? 12 : 6
  }, fields) : AncmntParameter_jsx(external_react_default.a.Fragment, null);
  return fields;
};
// EXTERNAL MODULE: ./src/helpers.ts
var helpers = __webpack_require__("vB4e");

// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/ancmnt_params/AncmntParamsContainer.tsx
var AncmntParamsContainer_jsx = external_react_default.a.createElement;

function AncmntParamsContainer_extends() { AncmntParamsContainer_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return AncmntParamsContainer_extends.apply(this, arguments); }
...
const AncmntParamsContainer = props => {
  const {
    isPreview,
    createAncmnt,
    values
  ...
  const data = isPreview ? adParams : Object(helpers["c" /* prepareCreateAncmnt */])(createAncmnt.subCategory.data, adParams);
  const classes = useStyles_useStyles({
    isPreview
  });
  return AncmntParamsContainer_jsx(core_["Grid"], {
    container: true,
    spacing: 2,
    className: classes.root
  }, Object.keys(data).map(key => AncmntParamsContainer_jsx(external_react_["Fragment"], {
    key: key
  }, AncmntParamsContainer_jsx(AncmntParameter, AncmntParamsContainer_extends({}, props, {
    keyName: key,
    data: data[key]
  })))));
};
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/ancmnt_auto_form/useStyles.js

const ancmnt_auto_form_useStyles_useStyles = Object(styles_["makeStyles"])(() => ({
  root: {}
}));
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/ancmnt_auto_form/AncmntAutoForm.tsx
var AncmntAutoForm_jsx = external_react_default.a.createElement;


const AncmntAutoForm = props => {
  const {
    form
  } = props;
  const classes = ancmnt_auto_form_useStyles_useStyles();
  return AncmntAutoForm_jsx("div", {
    className: classes.root
  }, form);
};
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/ancmnt_auto_form/accordion_component/useStyles.js

const accordion_component_useStyles_useStyles = Object(styles_["makeStyles"])(() => ({
  root: {
...
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/ancmnt_auto_form/accordion_component/AccordionComponent.tsx
var AccordionComponent_jsx = external_react_default.a.createElement;
...
const AccordionComponent = props => {
  ...
  const classes = accordion_component_useStyles_useStyles();
  return AccordionComponent_jsx("div", {
    className: classes.root
  }, AccordionComponent_jsx(core_["Accordion"], {
    expanded: true
  }, AccordionComponent_jsx(core_["AccordionSummary"], {
    id: "panel1a-header"
  }, AccordionComponent_jsx("img", {
    src: icon,
    alt: "icon"
  }), AccordionComponent_jsx(core_["Typography"], {
    className: classes.root
  }, title)), AccordionComponent_jsx(core_["AccordionDetails"], null, AccordionComponent_jsx(core_["Typography"], null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."))));
};
// EXTERNAL MODULE: ./src/components/elements/icons/index.tsx + 20 modules
var icons = __webpack_require__("myQD");

// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/ancmnt_auto_form/AncmntAutoFormContainer.tsx
var AncmntAutoFormContainer_jsx = external_react_default.a.createElement;

function AncmntAutoFormContainer_extends() { AncmntAutoFormContainer_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return AncmntAutoFormContainer_extends.apply(this, arguments); }
...
const AncmntAutoFormContainer = props => {
  const {
    t,
    createAncmnt,
    values
  ...
  const data = Object(helpers["c" /* prepareCreateAncmnt */])(createAncmnt.category.model, adParams);
  console.log(data);
  const autoData = {
    automobile: {
      icon: icons["b" /* Auto_icon */],
  ...
  const form = Object.keys(autoData).map((key, i) => {
    return AncmntAutoFormContainer_jsx(AccordionComponent, {
      key: i,
      title: t(key),
      icon: autoData[key].icon
    });
  });
  return AncmntAutoFormContainer_jsx(AncmntAutoForm, AncmntAutoFormContainer_extends({}, props, {
    form: form
  }));
};
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/useStyles.js

const ancmnt_form_useStyles_useStyles = Object(styles_["makeStyles"])(theme => ({
  root: {
...
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/AncmntForm.tsx
var AncmntForm_jsx = external_react_default.a.createElement;
...
const AncmntForm = props => {
  ...
  const classes = ancmnt_form_useStyles_useStyles();
  return subCategory.parent.id === 1 ? AncmntForm_jsx(AncmntAutoFormContainer, props) : AncmntForm_jsx("div", {
    className: classes.root
  }, AncmntForm_jsx(core_["Typography"], {
    variant: "h4",
    className: classes.title
  }, "\u041D\u043E\u0432\u043E\u0435 \u043E\u0431\u044A\u044F\u0432\u043B\u0435\u043D\u0438\u0435 - ", AncmntForm_jsx("span", null, subCategory.parent.name)), AncmntForm_jsx(core_["Grid"], {
    container: true,
    justify: "space-between",
    spacing: 2
  }, AncmntForm_jsx(core_["Grid"], {
    container: true,
    item: true,
    xs: 12,
    spacing: 2,
    ...
    xs: 12,
    container: true
  }, AncmntForm_jsx("div", null, AncmntForm_jsx(core_["Typography"], {
    variant: "subtitle1"
  }, AncmntForm_jsx("strong", null, "\u0422\u0438\u043F - ", `${ancmntType.name}`)))), AncmntForm_jsx(core_["Grid"], {
    item: true,
    xs: 12,
    container: true
  }, AncmntForm_jsx(core_["Typography"], {
    variant: "subtitle1"
  }, AncmntForm_jsx("strong", null, "\u041A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044F - ", `${subCategory.parent.name} `), subCategory.name && AncmntForm_jsx("strong", null, "- ", subCategory.name)))), AncmntForm_jsx(core_["Grid"], {
    item: true,
    container: true,
    xs: 12,
    spacing: 2,
    ...
    variant: "subtitle1"
  }, AncmntForm_jsx("strong", null, "\u0417\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A \u043E\u0431\u044A\u044F\u0432\u043B\u0435\u043D\u0438\u044F", !isPreview && AncmntForm_jsx("span", {
    className: "error-text"
  }, "*")), errors.title && touched.title && AncmntForm_jsx("span", {
    className: "error-text"
  }, " ", errors.title)), isPreview ? AncmntForm_jsx(core_["Typography"], null, values.title) : AncmntForm_jsx(CustomFormikField["a" /* CustomFormikField */], {
    className: errors.title && touched.title ? 'error-border' : '',
    name: "title",
    placeholder: "\u041F\u0440\u0438\u043C\u0435\u0440: Samsung S9 black 64 Gb",
    value: values.title
  }))), subCategory.id && AncmntForm_jsx(core_["Grid"], {
    item: true,
    container: true,
    ...
    variant: "h5"
  }, AncmntForm_jsx("strong", null, "\u041F\u0430\u0440\u0430\u043C\u0435\u0442\u0440\u044B"))), AncmntForm_jsx(AncmntParamsContainer, {
    t: t,
    isPreview: isPreview,
    values: values,
    ...
    justify: "space-between",
    spacing: 2
  }, isAuction && AncmntForm_jsx(core_["Grid"], {
    item: true,
    xs: 12
  }, AncmntForm_jsx(core_["Typography"], {
    variant: "h5"
  }, AncmntForm_jsx("strong", null, "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 \u0430\u0443\u043A\u0446\u0438\u043E\u043D\u0430"))), subCategory.parent.id !== 11 && AncmntForm_jsx(external_react_default.a.Fragment, null, AncmntForm_jsx(core_["Grid"], {
    item: true,
    xs: 12,
    sm: 6
  }, AncmntForm_jsx(core_["Grid"], {
    ...
    variant: "subtitle1"
  }, AncmntForm_jsx("strong", null, isAuction ? 'Стартовая цена в сумах' : 'Цена', !isPreview && AncmntForm_jsx("span", {
    className: "error-text"
  }, "*")), errors.price && touched.price && AncmntForm_jsx("span", {
    className: "error-text"
  }, " ", errors.price)), isPreview ? AncmntForm_jsx(core_["Typography"], null, `${values.price} ${values.currency.name}.`) : AncmntForm_jsx(core_["Grid"], {
    container: true
  }, AncmntForm_jsx(core_["Grid"], {
    item: true,
    xs: isAuction ? 12 : 9
  }, AncmntForm_jsx(core_["TextField"], {
    fullWidth: true,
    variant: "outlined",
    ...
    variant: "subtitle1"
  }, AncmntForm_jsx("strong", null, "\u0414\u043B\u0438\u0442\u0435\u043B\u044C\u043D\u043E\u0441\u0442\u044C \u0442\u043E\u0440\u0433\u043E\u0432 \u0432 \u0447\u0430\u0441\u0430\u0445"), errors.auction && errors.auction.duration && touched.duration && AncmntForm_jsx("span", {
    className: "error-text"
  }, " ", errors.auction.duration.id)), isPreview ? AncmntForm_jsx(core_["Typography"], null, `${values.auction.duration.expiration_at}`) : AncmntForm_jsx(CustomMenu, {
    name: "duration",
    ...
    onBlur: handleBlur
  }))), isAdvanceAuction && AncmntForm_jsx(external_react_default.a.Fragment, null, AncmntForm_jsx(core_["Grid"], {
    container: true,
    direction: "column",
    item: true,
    xs: 6
    ...
    variant: "subtitle1"
  }, AncmntForm_jsx("strong", null, "\u0420\u0435\u0437\u0435\u0440\u0432\u043D\u0430\u044F \u0446\u0435\u043D\u0430 \u0432 \u0441\u0443\u043C\u0430\u0445")), isPreview ? AncmntForm_jsx(core_["Typography"], null, values.auction.reserve_price) : AncmntForm_jsx(core_["TextField"], {
    variant: "outlined",
    ...
    item: true,
    xs: 6
  }, AncmntForm_jsx(CustomCheckbox, {
    disabled: isPreview,
    checked: values.auction.price_by_now.isActive,
    onChange: handleCheckboxChange('price_by_now')
  }), AncmntForm_jsx(core_["Typography"], {
    variant: "subtitle1"
  }, "\u041A\u0443\u043F\u0438\u0442\u044C \u0441\u0435\u0439\u0447\u0430\u0441")), values.auction.price_by_now.isActive && AncmntForm_jsx(core_["Grid"], {
    container: true,
    alignItems: "center",
    item: true,
    xs: 6
  }, isPreview ? AncmntForm_jsx(core_["Typography"], null, values.auction.price_by_now.value) : AncmntForm_jsx(core_["TextField"], {
    variant: "outlined",
    value: values.auction.price_by_now.value,
    onChange: handleAuctionInput('price_by_now')
  }), "\xA0", AncmntForm_jsx(core_["Typography"], null, "\u0441\u0443\u043C."))), AncmntForm_jsx(core_["Grid"], {
    container: true,
    item: true,
    xs: 12
  }, AncmntForm_jsx(core_["Grid"], {
    ...
    variant: "subtitle1"
  }, "\u0410\u0432\u0442\u043E\u043F\u0440\u043E\u0434\u0435\u043B\u0435\u043D\u0438\u0435"))), AncmntForm_jsx(core_["Grid"], {
    container: true,
    item: true,
    xs: 12
  }, AncmntForm_jsx(core_["Grid"], {
    ...
    variant: "subtitle1"
  }, "\u041F\u0440\u0435\u0434\u043B\u043E\u0436\u0438\u0442\u044C \u0446\u0435\u043D\u0443")))))), AncmntForm_jsx(core_["Grid"], {
    item: true,
    xs: 12
  }, AncmntForm_jsx(core_["Typography"], {
    variant: "h5",
    color: "initial"
  }, AncmntForm_jsx("strong", null, "\u041E\u043F\u043B\u0430\u0442\u0430 \u0438 \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0430"))), subCategory.parent.id !== 11 && AncmntForm_jsx(core_["Grid"], {
    container: true,
    item: true,
    xs: 12,
    alignItems: "center",
    ...
    variant: "subtitle1"
  }, "\u0411\u0435\u0437\u043E\u043F\u0430\u0441\u043D\u044B\u0439 \u0442\u043E\u0440\u0433")), AncmntForm_jsx(core_["Grid"], {
    item: true,
    xs: 9,
  ...
  }), AncmntForm_jsx(icons_["Help"], {
    className: "question-mark"
  }), AncmntForm_jsx(core_["Typography"], {
    variant: "subtitle2"
  }, "\u041F\u0440\u0438\u043C\u0435\u0447\u0430\u043D\u0438\u0435: \u0412\u044B \u043F\u043E\u0434\u043A\u043B\u044E\u0447\u0438\u043B\u0438 \u0443\u0441\u043B\u0443\u0433\u0443 \xAB\u0411\u0435\u0437\u043E\u043F\u0430\u0441\u043D\u044B\u0439 \u0442\u043E\u0440\u0433\xBB. \u0412\u0430\u0448\u0430 \u0441\u0434\u0435\u043B\u043A\u0430 \u0437\u0430\u0449\u0438\u0449\u0435\u043D\u0430. \u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C \u0443\u0441\u043B\u0443\u0433\u0438 \u0441\u043E\u0441\u0442\u0430\u0432\u043B\u044F\u0435\u0442 n%.", ' ', AncmntForm_jsx("a", {
    href: "#"
  }, AncmntForm_jsx("span", {
    className: "safe-auction-rules"
  }, "\u041E\u0437\u043D\u0430\u043A\u043E\u043C\u0438\u0442\u044C\u0441\u044F \u0441 \u043F\u0440\u0430\u0432\u0438\u043B\u0430\u043C\u0438 \xAB\u0411\u0435\u0437\u043E\u043F\u0430\u0441\u043D\u044B\u0439 \u0442\u043E\u0440\u0433\xBB"))))), AncmntForm_jsx(core_["Grid"], {
    container: true,
    item: true,
    xs: 12,
    alignItems: "center",
    ...
    variant: "subtitle1"
  }, "\u0415\u0441\u0442\u044C \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0430")), AncmntForm_jsx(core_["Grid"], {
    item: true,
    xs: 9,
    className: classes.paymentAndDelivery
  }, AncmntForm_jsx(CustomCheckbox, {
    ...
    variant: "subtitle2"
  }, "\u041F\u0440\u0438\u043C\u0435\u0447\u0430\u043D\u0438\u0435: \u0412\u044B \u0431\u0443\u0434\u0435\u0442\u0435 \u0432\u044B\u0434\u0435\u043B\u0435\u043D\u044B \u0441\u043F\u0435\u0446\u0438\u0430\u043B\u044C\u043D\u044B\u043C \u0441\u0442\u0438\u043A\u0435\u0440\u043E\u043C \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0430. \u0414\u043E\u0441\u0442\u0430\u0432\u043A\u0430 \u043E\u0441\u0443\u0449\u0435\u0441\u0442\u0432\u043B\u044F\u0435\u0442\u0441\u044F \u0437\u0430 \u0412\u0430\u0448 \u0441\u0447\u0435\u0442. \u0412 \u0441\u043B\u0443\u0447\u0430\u0435 \u043D\u0435\u0432\u044B\u043F\u043E\u043B\u043D\u0435\u043D\u0438\u044F \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0438, \u0412\u044B \u043C\u043E\u0436\u0435\u0442\u0435 \u0431\u044B\u0442\u044C \u0437\u0430\u0431\u043B\u043E\u043A\u0438\u0440\u043E\u0432\u0430\u043D\u044B.", AncmntForm_jsx("a", {
    href: "#"
  }, AncmntForm_jsx("span", {
    className: "safe-auction-rules"
  }, "\u041E\u0437\u043D\u0430\u043A\u043E\u043C\u0438\u0442\u044C\u0441\u044F \u0441 \u043F\u0440\u0430\u0432\u0438\u043B\u0430\u043C\u0438 \xAB\u0415\u0441\u0442\u044C \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0430\xBB"))))), AncmntForm_jsx(core_["Grid"], {
    container: true,
    item: true,
    xs: 12,
    direction: "row",
    ...
    variant: "subtitle1"
  }, "\u0412\u043E\u0437\u043C\u043E\u0436\u0435\u043D \u043E\u0431\u043C\u0435\u043D")), AncmntForm_jsx(core_["Grid"], {
    item: true,
    xs: 9,
    className: classes.paymentAndDelivery
  }, AncmntForm_jsx(CustomCheckbox, {
    ...
    variant: "subtitle2"
  }, "\u041F\u0440\u0438\u043C\u0435\u0447\u0430\u043D\u0438\u0435: \u0412\u044B \u043F\u0440\u0438\u043D\u0438\u043C\u0430\u0435\u0442\u0435 \u043F\u0440\u0435\u0434\u043B\u043E\u0436\u0435\u043D\u0438\u044F \u043E\u0442 \u0434\u0440\u0443\u0433\u0438\u0445 \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u0435\u0439 \u043D\u0430 \u043E\u0431\u043C\u0435\u043D. \u0412\u044B \u0431\u0443\u0434\u0435\u0442\u0435 \u0432\u044B\u0434\u0435\u043B\u0435\u043D\u044B \u0441\u043F\u0435\u0446\u0438\u0430\u043B\u044C\u043D\u044B\u043C ", AncmntForm_jsx("br", null), "\u0441\u0442\u0438\u043A\u0435\u0440\u043E\u043C \xAB\u0412\u043E\u0437\u043C\u043E\u0436\u0435\u043D \u043E\u0431\u043C\u0435\u043D\xBB"))), AncmntForm_jsx(core_["Grid"], {
    container: true,
    item: true,
    direction: "row",
    justify: "space-between",
    ...
    variant: "subtitle1"
  }, AncmntForm_jsx("strong", null, "\u041C\u0435\u0441\u0442\u043E\u043F\u043E\u043B\u043E\u0436\u0435\u043D\u0438\u0435", !isPreview && AncmntForm_jsx("span", {
    className: "error-text"
  }, "*")), errors.location && touched.location && AncmntForm_jsx("span", {
    className: "error-text"
  }, " ", errors.location)), isPreview ? AncmntForm_jsx(core_["Typography"], null, values.location.district ? `${values.location.district}, ${values.location.city}, ` : `${values.location.city}, `, `${values.location.region}.`) : AncmntForm_jsx(LocationAutocomplete, {
    name: "location",
    ...
    variant: "subtitle1"
  }, AncmntForm_jsx("strong", null, "\u0424\u043E\u0442\u043E\u0433\u0440\u0430\u0444\u0438\u0438", !isPreview && AncmntForm_jsx("span", {
    className: "error-text"
  }, "*")), errors.files && touched.files && AncmntForm_jsx("span", {
    className: "error-text"
  }, " ", errors.files)), AncmntForm_jsx(PreviewPhotos, {
    values: values,
    setValues: setValues,
    isPreview: isPreview
  }))), AncmntForm_jsx(core_["Grid"], {
    ...
    variant: "subtitle1"
  }, AncmntForm_jsx("strong", null, "\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435", !isPreview && AncmntForm_jsx("span", {
    className: "error-text"
  }, "*")), errors.description && touched.description && AncmntForm_jsx("span", {
    className: "error-text"
  }, " ", errors.description)), isPreview ? AncmntForm_jsx(core_["Typography"], null, values.description) : AncmntForm_jsx(CustomFormikTextarea, {
    name: "description",
    onBlur: handleBlur,
    className: `${classes.description} ${errors.description && touched.description ? 'error-border' : ''}`,
    rowsMin: 15,
    ...
    direction: "column",
    justify: "center"
  }, ancmntType.id !== 1 && AncmntForm_jsx(core_["Grid"], {
    item: true,
    container: true,
    direction: "row",
    alignItems: "center"
    ...
    variant: "subtitle1"
  }, "\u041E\u0442\u043E\u0431\u0440\u0430\u0436\u0430\u0442\u044C \u043D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430")), AncmntForm_jsx(core_["Grid"], {
    item: true
  }, AncmntForm_jsx(core_["Typography"], {
    variant: "subtitle1"
  }, AncmntForm_jsx("strong", null, "\u0412\u0430\u0448 \u0442\u0435\u043B\u0435\u0444\u043E\u043D")), isPreview ? AncmntForm_jsx(core_["Typography"], null, "+998909998877") : AncmntForm_jsx(CustomFormikField["a" /* CustomFormikField */], {
    disabled: true,
    type: "tel",
    name: "phone",
    value: "+998909998877"
  })), (isPreview && values.phone || !isPreview) && AncmntForm_jsx(core_["Grid"], {
    item: true
  }, AncmntForm_jsx(core_["Typography"], {
    variant: "subtitle1"
  }, AncmntForm_jsx("strong", null, "\u0414\u043E\u043F\u043E\u043B\u043D\u0438\u0442\u0435\u043B\u044C\u043D\u044B\u0439 \u0442\u0435\u043B\u0435\u0444\u043E\u043D")), isPreview ? AncmntForm_jsx(core_["Typography"], null, values.phone) : AncmntForm_jsx(CustomFormikField["a" /* CustomFormikField */], {
    type: "tel",
    name: "phone",
  ...
  }, !isPreview && AncmntForm_jsx("div", {
    className: "switcher"
  }, AncmntForm_jsx(core_["Typography"], {
    variant: "subtitle1"
  }, AncmntForm_jsx("strong", null, "\u0412\u0440\u0435\u043C\u044F \u0437\u0432\u043E\u043D\u043A\u043E\u0432")), AncmntForm_jsx(core_["Switch"], {
    color: "primary",
    checked: values.avalTime.isActive,
    onChange: handleSwitch
  })), (isPreview && values.avalTime.isActive || !isPreview) && AncmntForm_jsx(external_react_default.a.Fragment, null, AncmntForm_jsx(core_["Paper"], {
    className: "scheduler"
  }, AncmntForm_jsx("div", {
    className: "week-days"
  }, [{
    ...
    id: 7,
    name: 'Вс'
  }].map(day => AncmntForm_jsx(CustomCheckbox, {
    disabled: !values.avalTime.isActive || isPreview,
    key: day.id,
    checked: values.avalTime.isActive && values.avalTime.week.some(({
      id
    }) => id === day.id),
    checkedIcon: AncmntForm_jsx(core_["Typography"], {
      className: "selected-day"
    }, day.name),
    icon: AncmntForm_jsx(core_["Typography"], null, day.name),
    onChange: handleWeekDay(day)
  }))), AncmntForm_jsx("div", {
    className: "available-time"
  }, AncmntForm_jsx("div", null, AncmntForm_jsx(core_["Typography"], null, "\u0421"), AncmntForm_jsx(core_["TextField"], {
    variant: "outlined",
    name: "start_time",
    onChange: handleTime,
    onBlur: handleBlur,
    ...
    disabled: !values.avalTime.isActive || isPreview
  })), AncmntForm_jsx("div", null, AncmntForm_jsx(core_["Typography"], null, "\u0414\u043E"), AncmntForm_jsx(core_["TextField"], {
    variant: "outlined",
    name: "end_time",
    onChange: handleTime,
    onBlur: handleBlur,
    ...
    disabled: !values.avalTime.isActive || isPreview
  })))), !isPreview && AncmntForm_jsx("a", {
    href: "#",
    className: "settings"
  }, "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438")))))), AncmntForm_jsx("div", {
    className: classes.nextButtonBlock
  }, AncmntForm_jsx(Button["a" /* ButtonComponent */], {
    type: "submit",
    disabled: values.isFetch,
    className: classes.navButton
  }, AncmntForm_jsx(core_["Typography"], null, isPreview ? 'Создать' : 'Далее'))));
};
// EXTERNAL MODULE: ./src/redux/slices/errorSlice.ts
var errorSlice = __webpack_require__("jigt");

// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/AncmntFormContainer.tsx
var AncmntFormContainer_jsx = external_react_default.a.createElement;

function AncmntFormContainer_extends() { AncmntFormContainer_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return AncmntFormContainer_extends.apply(this, arguments); }

function AncmntFormContainer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function AncmntFormContainer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { AncmntFormContainer_ownKeys(Object(source), true).forEach(function (key) { AncmntFormContainer_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { AncmntFormContainer_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function AncmntFormContainer_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
const autoSelectKeys = ['condition', 'area'];
const textFieldKeys = ['area'];
const initPhoto = {
  url: AncmntFormContainer_jsx("div", {
    style: {
      width: '120px',
      height: '120px',
      margin: 'auto'
    }
  }, AncmntFormContainer_jsx(icons["e" /* CameraIcon */], null))
};
const initPhotos = Array.from({
  length: constants["c" /* TOTAL_FILES_LIMIT */]
}).map(() => initPhoto);
...
const formData = (data, ancmntType, subCategory) => {
...
const AncmntFormContainer = props => {
  const {
    activeStep,
    ancmntType,
    handleNextStep,
  ...
  const {
    locations
  } = Object(external_react_redux_["useSelector"])(store => store);
  ...
  async function onSubmit(values) {
    try {
      if (activeStep !== 3) {
        ...
        setValues(AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, values), {}, {
          isFetch: true
        }));
      ...
      dispatch(Object(errorSlice["c" /* setErrorMsgAction */])(e.message));
      setValues(AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, values), {}, {
        isFetch: false
      }));
    }
  ...
  const handleCheckboxChange = valName => ({
    ...
    if (isAuctionField) {
      setValues(AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, values), {}, {
        auction: AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, values.auction), {}, {
  ...
  const handleParamsCheckbox = (valueName, value) => () => {
    if (adParams[valueName]) {
      if (adParams[valueName].some(val => val.id === value.id)) {
        ...
        adParams = AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, adParams), {}, {
  ...
  const handleInput = valueName => ({
    ...
    if (helpers["b" /* numberRegEx */].test(target.value)) {
      if (valueName === 'price') {
        setValues(AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, values), {}, {
  ...
  const handleSwitch = (_, value) => {
    setValues(AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, values), {}, {
      avalTime: AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, values.avalTime), {}, {
        isActive: value
      })
    }));
  };
  ...
  const handleWeekDay = value => () => {
    if (values.avalTime.week.some(val => val.id === value.id)) {
      ...
      setValues(AncmntFormContainer_objectSpread({}, values));
    } else {
      setValues(AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, values), {}, {
        avalTime: AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, values.avalTime), {}, {
  ...
  const setReqValues = () => {
    ...
    if (ancmntType.id !== 1 && ancmntType.expired.length !== 0) {
      reqVals['auction'] = AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, values.auction), {}, {
    ...
    setValues(AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, values), reqVals), {}, {
      adParams: AncmntFormContainer_objectSpread(AncmntFormContainer_objectSpread({}, adParams), reqParamsVals)
    }));
  };
  ...
  return AncmntFormContainer_jsx(external_formik_["FormikProvider"], {
    value: formik
  }, AncmntFormContainer_jsx("form", {
    onSubmit: handleSubmit
  }, AncmntFormContainer_jsx(AncmntForm, AncmntFormContainer_extends({}, props, {
    errors: errors,
    touched: touched,
...
// CONCATENATED MODULE: ./src/components/announcement/ancmnt_types_page/useStyles.js

const ancmnt_types_page_useStyles_useStyles = Object(styles_["makeStyles"])(() => ({
  root: {
    marginBottom: '30px',
    '& div.MuiGrid-item': {
      '& > button': {
...
// CONCATENATED MODULE: ./src/components/announcement/ancmnt_types_page/AncmntTypesPage.tsx
var AncmntTypesPage_jsx = external_react_default.a.createElement;



const AncmntTypesPage = ({
  ancmntTypes,
  handleAncmntType
}) => {
  const classes = ancmnt_types_page_useStyles_useStyles();
  return AncmntTypesPage_jsx("div", {
    className: classes.root
  }, AncmntTypesPage_jsx(core_["Grid"], {
    container: true,
    spacing: 2
  }, ancmntTypes.map((anType, i) => {
    return AncmntTypesPage_jsx(core_["Grid"], {
      item: true,
      xs: 4,
      key: i
    }, AncmntTypesPage_jsx(core_["ButtonBase"], {
      onClick: handleAncmntType(anType),
      style: {
        backgroundImage: `url(${anType.image.url})`
      }
    }, AncmntTypesPage_jsx("div", null, AncmntTypesPage_jsx(core_["Typography"], {
      variant: "subtitle1"
    }, anType.name), AncmntTypesPage_jsx(core_["Typography"], {
      variant: "body2"
    }, "\u0420\u0430\u0437\u043C\u0435\u0449\u0430\u0439\u0442\u0435 \u0442\u043E\u0432\u0430\u0440\u044B \u0438\u043B\u0438 \u0443\u0441\u043B\u0443\u0433\u0438 \u0441\u043E\u0432\u0435\u0440\u0448\u0435\u043D\u043D\u043E \u0431\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u043E"))));
  })));
};
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_header/useStyles.js

const ancmnt_header_useStyles_useStyles = Object(core_["makeStyles"])(theme => ({
  root: {
    display: 'flex',
    justifyContent: 'space-between',
    alignItems: 'center',
...
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_header/AncmntHeader.tsx
var AncmntHeader_jsx = external_react_default.a.createElement;
...
const AncmntHeader = ({
  ...
  const classes = ancmnt_header_useStyles_useStyles();
  return AncmntHeader_jsx("div", {
    className: classes.root
  }, AncmntHeader_jsx(Button["a" /* ButtonComponent */], {
    className: "back-btn",
    onClick: handleBackBtn
  }, "\u041D\u0430\u0437\u0430\u0434"), AncmntHeader_jsx("div", {
    className: "stepper-wrapper"
  }, AncmntHeader_jsx(core_["Stepper"], {
    activeStep: activeStep,
    alternativeLabel: true
  }, steps.map(label => AncmntHeader_jsx(core_["Step"], {
    key: label
  }, AncmntHeader_jsx(core_["StepLabel"], null, label))))));
};
...
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/success_ancmnt/useStyles.js

const success_ancmnt_useStyles_useStyles = Object(styles_["makeStyles"])(theme => ({
  root: {
    '& a': {
      textDecoration: 'none'
    }
...
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/ancmnt_form/success_ancmnt/SuccessAncmnt.tsx
var SuccessAncmnt_jsx = external_react_default.a.createElement;
...
const SuccessAncmnt = ({
  handleCreateNewAncmnt
}) => {
  Object(external_react_["useEffect"])(() => {
    window && window.scrollTo(0, 0);
  }, []);
  const classes = success_ancmnt_useStyles_useStyles();
  return SuccessAncmnt_jsx("div", {
    className: classes.root
  }, SuccessAncmnt_jsx(core_["Grid"], {
    container: true,
    spacing: 1
  }, SuccessAncmnt_jsx(core_["Grid"], {
    item: true,
    xs: 12
  }, SuccessAncmnt_jsx(core_["Typography"], {
    variant: "h4",
    color: "initial",
    className: classes.title
  }, "\u041F\u043E\u0437\u0434\u0440\u0430\u0432\u043B\u044F\u0435\u043C!")), SuccessAncmnt_jsx(core_["Grid"], {
    item: true,
    xs: 12
  }, SuccessAncmnt_jsx(core_["Paper"], {
    elevation: 1,
    ...
    alignItems: "center",
    alignContent: "center"
  }, SuccessAncmnt_jsx("div", {
    className: classes.successInfo
  }, SuccessAncmnt_jsx(CheckCircle_default.a, {
    color: "primary",
    className: classes.successIcon
  }), SuccessAncmnt_jsx(core_["Typography"], {
    color: "initial"
  }, "\u041E\u0431\u044A\u044F\u0432\u043B\u0435\u043D\u0438\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043E \u043D\u0430 \u043C\u043E\u0434\u0435\u0440\u0430\u0446\u0438\u044E. ", SuccessAncmnt_jsx("br", null), "\u0421\u0442\u0430\u0442\u0443\u0441 \u043E\u0431\u044A\u044F\u0432\u043B\u0435\u043D\u0438\u044F \u0412\u044B \u043C\u043E\u0436\u0435\u0442\u0435 \u043E\u0442\u0441\u043B\u0435\u0436\u0438\u0432\u0430\u0442\u044C \u0432 ", ' ', SuccessAncmnt_jsx("a", {
    href: "#"
  }, "\u043B\u0438\u0447\u043D\u043E\u043C \u043A\u0430\u0431\u0438\u043D\u0435\u0442\u0435")))))), SuccessAncmnt_jsx(core_["Grid"], {
    item: true,
    container: true,
    xs: 12,
    direction: "row",
    ...
    xs: 6,
    sm: 2
  }, SuccessAncmnt_jsx(Button["a" /* ButtonComponent */], {
    onClick: handleCreateNewAncmnt,
    style: {
      color: '#fff'
    }
  }, "\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u0435\u0449\u0435")), SuccessAncmnt_jsx(core_["Grid"], {
    item: true,
    xs: 6,
    sm: 2
  }, SuccessAncmnt_jsx(i18n["a" /* Link */], {
    href: "/"
  }, SuccessAncmnt_jsx("a", null, SuccessAncmnt_jsx(Button["a" /* ButtonComponent */], {
    style: {
      color: '#fff'
    }
  }, SuccessAncmnt_jsx(Home_default.a, {
    color: "inherit"
  }), "\u041D\u0430 \u0433\u043B\u0430\u0432\u043D\u0443\u044E"))))), SuccessAncmnt_jsx(core_["Grid"], {
    item: true,
    container: true,
    xs: 12,
    direction: "row",
...
// CONCATENATED MODULE: ./src/components/announcement/create_ancmnt/CreateAncmntContainer.tsx
var CreateAncmntContainer_jsx = external_react_default.a.createElement;

function CreateAncmntContainer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function CreateAncmntContainer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { CreateAncmntContainer_ownKeys(Object(source), true).forEach(function (key) { CreateAncmntContainer_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { CreateAncmntContainer_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function CreateAncmntContainer_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
const CreateAncmntContainer_steps = ['Тип объявления', 'Категория', 'Заполнение', 'Проверка'];
...
const CreateAncmntContainer = ({
  ...
  const categoriesList = Object(external_react_redux_["useSelector"])(({
    categories
  }) => {
    return Object(helpers["a" /* categoryDataNormalization */])(categories.list); // return categories.list;
  });
  const dispatch = Object(external_react_redux_["useDispatch"])();
  const {
    0: ancmntType,
    1: setAncmntType
  } = Object(external_react_["useState"])(initAncmntTypeState);
  const {
    0: ancmntTypes,
    1: setAncmntTypes
  } = Object(external_react_["useState"])(initAncmntTypeStates);
  const {
    0: createAncmnt,
    1: setCreateAncmnt
  } = Object(external_react_["useState"])(initCreateAncmntState);
  const {
    0: subLvlCtgrs,
    1: setSubLvlCtgrs
  ...
  const handleCategory = category => () => {
    try {
      ...
      dispatch(Object(errorSlice["c" /* setErrorMsgAction */])(e.message));
      setCreateAncmnt(CreateAncmntContainer_objectSpread(CreateAncmntContainer_objectSpread({}, createAncmnt), {}, {
        isFetch: false
      }));
    }
  };
  ...
  const handleSubCategory = (parent, child_id, name) => async () => {
    try {
      ...
      const data = await api["a" /* userAPI */].getDataForCreateAncmnt(parent.id, child_id, lang);
      setCreateAncmnt(CreateAncmntContainer_objectSpread(CreateAncmntContainer_objectSpread({}, createAncmnt), {}, {
  ...
  const renderPageByActiveStep = () => {
    switch (activeStep) {
      case 0:
        return CreateAncmntContainer_jsx(AncmntTypesPage, {
          ancmntTypes: ancmntTypes.types,
          handleAncmntType: handleAncmntType
        });

      case 1:
        return CreateAncmntContainer_jsx(CreateAncmnt, {
      ...
      case 4:
        return CreateAncmntContainer_jsx(SuccessAncmnt, {
          handleCreateNewAncmnt: handleResetAncmntType
        });

      default:
        return CreateAncmntContainer_jsx(AncmntFormContainer, {
          t: t,
          activeStep: activeStep,
          ancmntType: ancmntType,
          createAncmnt: createAncmnt,
  ...
  return CreateAncmntContainer_jsx(MainLayout["a" /* MainLayout */], null, activeStep !== 0 && activeStep !== 4 && CreateAncmntContainer_jsx(AncmntHeader, {
    steps: CreateAncmntContainer_steps,
    activeStep: activeStep,
...
// CONCATENATED MODULE: ./pages/announcement/create.tsx
...
const Create = props => {
  return create_jsx(CreateAncmntContainer, props);
};
...
/* harmony default export */ var create = __webpack_exports__["default"] = (Object(external_next_i18next_["withTranslation"])(['ancmnt', 'common'])(Create));
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return transformTitle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return numberRegEx; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return categoryDataNormalization; });
/* unused harmony export categorySearchHelper */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return prepareCreateAncmnt; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return pricePrettier; });
/* harmony import */ var cyrillic_to_translit_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("S41T");
...
const transformTitle = title => {
  const transform = new cyrillic_to_translit_js__WEBPACK_IMPORTED_MODULE_0___default.a().transform;
  const formatRegEx = /[\-\,\.\;\"\']+/g;
...
const categoryDataNormalization = categoryList => categoryList.map(ctgr => {
  if (ctgr.model) {
...
const categorySearchHelper = (text, categoryList) => {
...
const prepareCreateAncmnt = (data, adParams) => Object.keys(data).reduce((acc, key) => {
...
const pricePrettier = price => price && price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, " ");
