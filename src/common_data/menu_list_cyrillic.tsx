...
const Car = '/img/categories_img/Легковые автомобили.png';
const Transport = '/img/categories_img/Спецтехника и транспорт.png';
const Parts = '/img/categories_img/Запчасти и аксессуары.png';
const Estate = '/img/categories_img/Недвижимость.png';
const Job = '/img/categories_img/Работа.png';
const Service = '/img/categories_img/Услуги.png';
const Goods = '/img/categories_img/Вещи, Детские товары и украшения.png';
const Home = '/img/categories_img/Для дома и дачи.png';
const Electronics = '/img/categories_img/Электроника.png';
const Hobbies = '/img/categories_img/Хобби и отдых.png';
const Animal = '/img/categories_img/Животные.png';
const Free = '/img/categories_img/Отдам даром.png';

export const menu_list_cyrillic: CategoryType[] = [
    {
        id: 1,
        ...
        subCategory: [
            {
                id: 1,
                name: 'Сделано в Узбекистане',
                parents: [{id: 1, name: 'Легковые автомобили'}],
            },
            {
                id: 2,
                name: 'Иномарки',
        ...
        subCategory: [
            {
                ...
                parents: [{id: 2, name: 'Спецтехника и транспорт'}],
                type: [
                    {
                        id: 1,
                        name: 'Мотоциклы',
                        parents: [
                            {id: 2, name: 'Спецтехника и транспорт'},
                            {id: 1, name: 'Мотоциклы и мототехника'},
                        ]
                    },
                    {
                        id: 2,
                ...
                type: [
                    {
                        ...
                        parents: [
                            {id: 2, name: 'Спецтехника и транспорт'},
                            {id: 2, name: 'Автобусы и грузовики'},
                        ],
                    },
                    {
                        id: 8,
        ...
        subCategory: [
            {
                id: 1,
                name: 'forCars',
                parents: [{id: 3, name: 'Запчасти и аксессуары'}],
            },
            {
                id: 2,
                ...
                type: [
                    {
                        ...
                        'name': 'Мотоциклы',
                        parents: [
                            {id: 1, name: 'Запчасти и аксессуары'},
        ...
        subCategory: [
            {
                id: 1,
                name: 'Квартиры',
                parents: [{id: 4, name: 'Недвижимость'}],
                type: [
                    {
                        id: 1,
                        name: 'sale',
    ...
    {
        id: 7,
        name: 'Вещи, Детские товары и украшения',
        has_auction: true,
        icon: {url: Goods},
        ...
        subCategory: [
            {
                ...
                parents: [{id: 7, name: 'Вещи, Детские товары и украшения'}],
                type: [
                    {
                        id: 1,
                        name: 'Аксессуары',
                        parents: [
                            {id: 7, name: 'Вещи, Детские товары и украшения'},
                            {id: 1, name: 'Женский гардероб'},
                        ],
                    },
                    {
                        id: 2,
        ...
        subCategory: [
            {
                ...
                parents: [{id: 8, name: 'Для дома и дачи'}],
                type: [
                    {
                        id: 1,
                        name: 'sofasAndArmchairs',
                        parents: [
                            {id: 8, name: 'Для дома и дачи'},
                            {id: 1, name: 'Мебель и интерьер'},
                        ],
                    },
                    {
                        id: 2,
        ...
        subCategory: [
            {
                id: 1,
                name: 'tickets',
                parents: [{id: 10, name: 'Хобби и отдых'}]
            },
            {
                id: 2,
                'name': 'Спорт и отдых',
