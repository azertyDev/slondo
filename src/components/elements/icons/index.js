...
const HelpIcon = `icons/help_icon.svg`
const StoreIcon = `icons/store_icon.svg`
const BusinessIcon = `icons/bz_icon.svg`
const PlIcon = `icons/pl_icon.svg`
const Logo = `icons/logo.svg`
const CategoryIcon = `icons/kat_icon.svg`
const SearchIcon = `icons/sr_icon.svg`
const SignIcon = `icons/sign.svg`
const AddIcon = `icons/add.svg`
const LeftArrowIcon = `icons/slide_left_icon.svg`
const RightArrowIcon = `icons/slide_right_icon.svg`
const CarIcon = `icons/legkovoe_avto_optim_fin.svg`
